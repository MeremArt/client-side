        ...
        <div className='navbar'>
            ...
            <div className="nav">
                <div className="nav-logo">
                    {/* <p>HYVE</p> */}
                    <img src={HyveLogo} alt="Hyve Logo" />
                </div>
                ...
                <div className="nav-profile">
                    ...
                    <div className="profile-name-section">
                        <div className="name">
                            <p>{`${user_data && user_data.firstName}  ${user_data && user_data.lastName}`}</p>
                            <ArrowDown2 size="20" color="#404040" variant="Bold" />
                        </div>
                        <div className="name-id">
                            <p>User ID: {user_data && user_data.hyveId}</p>
                            <div className="copy" >
                                <Copy size="17" color='#808080' className='copy-icon'
                                   onClick={()=>userData && handleCopy(userData.hyveId)} text={user_data && user_data.hyveId} 
                                />
