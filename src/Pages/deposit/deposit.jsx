            ...
            <div className="boxwrap">
                <div className="deposit-control">
                    <div className="switchs">
                        ...
                        <div className={activeComponent === 2 || activeComponent2 === 2?   'active controls' : 'controls'}>
                            <div className="sml-crl sml">2</div>
                            <p>Payment amount</p>
                            <ArrowRight2 size="15" color="#ADBED8"/>
                        </div>
                        <div className={activeComponent === 3  || activeComponent2 === 2 ? 'active controls' : 'controls'}>
                            <div className="sml-crl sml">3</div>
                            <p>{activeComponent === 3 ? 'Bank details' : 'Make payment'}</p>
                            <ArrowRight2 size="15" color="#ADBED8"/>
                        </div>
                        <div className={activeComponent === 4  || activeComponent2 === 3 ? 'active controls' : 'controls'}>
                ...
                {activeComponent === 1 && <Transfer onNext={handleNextComponent} onNext2={handleNextComponent2} style={componentStyle} />}
                {activeComponent === 2 && <MakePayment onNext={handleNextComponent} options={options} handleGoBack={handleGoBack}/>}
                {activeComponent === 3 && <Seebankdetails onNext={handleNextComponent} handleGoBack={handleGoBack}/>}
                {activeComponent === 4 && <Successdeposit onNext={handleNextComponent} handleGoBack={handleGoBack}/>}

                

                {/* {activeComponent2 === 2 && <Paywithcrypto onNext2={handleNextComponent2} />} */}
                {activeComponent2 === 2 && < Makecryptopayment onNext2={handleNextComponent2} handleGoBack={handleGoBack}/>}
                {activeComponent2 === 3 && < Cryptoconfirmation onNext2={handleNextComponent2} />}
