      ...
      <div className="pagenotfound-container">
        ...
        <div className="pagenotfound">
          <div className="pagenotfound-text">
            <h2>Oops!</h2>
            <p className="notfound-msg1">This page cannot be found</p>
            <p className="notfound-msg2">
              Sorry, the page you are looking for is not available. <br /> Don’t
              worry, everything is still awesome! You can return <br /> to
              homepage.
            </p>
